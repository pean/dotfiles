...
echo ""
echo "============================================================================="
echo "Formatting Features (React/Next.js optimized)"
echo "============================================================================="
echo "  Auto-format on save    - Enabled by default (uses Prettier for JS/TS/React)"
echo "  <leader>mp             - Manual format current file/selection"
echo "  :FormatDisable         - Disable auto-format globally"
echo "  :FormatDisable!        - Disable auto-format for current buffer only"
echo "  :FormatEnable          - Re-enable auto-format"
echo ""
echo "Prettier configuration:"
echo "  - 2 spaces indentation"
echo "  - Double quotes"
echo "  - Semicolons enabled"
echo "  - Trailing commas (ES5)"
echo "  - JSX bracket formatting"
echo ""
echo "============================================================================="
